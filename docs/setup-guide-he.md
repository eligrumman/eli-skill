...
2. תיבה מומלצת: **CX43** — 4 vCPU, 16GB RAM, 160GB SSD, בערך $14 לחודש. מריץ בנוחות **~30–40+** סשנים של Claude Code במקביל. (התיבה הקטנה יותר **CX22**, 8GB, בערך $8 לחודש, מריצה בנוחות **~10–20**.) ראו את הערת הקיבולת למטה — RAM כמעט אף פעם אינו המגבלה האמיתית.
...
> **כמה אייג'נטים זה באמת יכול להריץ?** הרבה יותר ממה שנדמה לכם. על Mac עם 32GB הבעלים הריץ **35 סשנים של Claude Code בו-זמנית** — כל אחד נע בין ~65MB (במנוחה) ל-~740MB (בעבודה פעילה), **חציון ~320MB, ממוצע ~367MB RSS** (ו-RSS סופר-יתר על המידה זיכרון framework משותף, כך שהעלות התוספתית האמיתית לכל סשן נוסף נמוכה יותר). כלל אצבע: סשן **במנוחה** הוא ~50–150MB; סשן **שעובד קשה** כמה מאות MB. אז **CX22 (8GB) מריץ בנוחות ~10–20 סשנים; CX43 (16GB) מריץ ~30–40+** (בקירוב).
>
